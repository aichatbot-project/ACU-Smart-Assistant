...
RAG_MAX_CHARS = max(800, int(os.environ.get("RAG_MAX_CHARS", "1800")))
RAG_TOP_K = int(os.environ.get("RAG_TOP_K", "8"))
RAG_VECTOR_FILL_EXTRA = max(0, int(os.environ.get("RAG_VECTOR_FILL_EXTRA", "3")))
...
RAG_VECTOR_CANDIDATE_POOL = max(20, min(500, int(os.environ.get("RAG_VECTOR_CANDIDATE_POOL", "28"))))
